...
include::{snippets}/artists-free-creations-get/http-request.adoc[]
include::{snippets}/artists-free-creations-get/http-response.adoc[]
include::{snippets}/artists-free-creations-get/response-fields.adoc[]

==== 에러 케이스 - 아티스트 없음

include::{snippets}/artists-free-creations-get-not-found/http-request.adoc[]
include::{snippets}/artists-free-creations-get-not-found/http-response.adoc[]
include::{snippets}/artists-free-creations-get-not-found/response-fields.adoc[]

==== 에러 케이스 - 삭제된 아티스트

include::{snippets}/artists-free-creations-get-deleted-artist/http-request.adoc[]
include::{snippets}/artists-free-creations-get-deleted-artist/http-response.adoc[]
include::{snippets}/artists-free-creations-get-deleted-artist/response-fields.adoc[]
