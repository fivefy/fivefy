...
<th style="width: 40%; text-align: center; vertical-align: middle;">기여</th>
...
<td style="text-align: center; vertical-align: middle;">JWT/OAuth2 인증, 회원 탈퇴 2단계 처리, CI/CD</td>
...
<td style="text-align: center; vertical-align: middle;">Artist/Album/Track, 성능 개선, Redis 캐싱</td>
...
<td style="text-align: center; vertical-align: middle;">알림 시스템, Follow/Like, Outbox, RabbitMQ</td>
...
<td style="text-align: center; vertical-align: middle;">Playback 상태 전이 설계, PlaylistTrack 성능 개선, PopularChart Snapshot</td>
...
<td style="text-align: center; vertical-align: middle;">PortOne V2 결제, 포인트/지갑, 정기결제 스케줄러</td>
