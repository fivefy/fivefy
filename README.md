...
> 대용량 음악 스트리밍 환경을 가정해 설정한 설계·성능 목표

|                 🎯                  |                  📊                   |                 ⚡                  |                  ⏱️                  |                   📅                   |
|:-----------------------------------:|:-------------------------------------:|:----------------------------------:|:------------------------------------:|:--------------------------------------:|
| **트랙 1억 건**<br><sub>목표 데이터 규모</sub> | **월 3,000만 건**<br><sub>목표 재생 기록</sub> | **RPS 1,000**<br><sub>목표 처리량</sub> | **P95 200ms**<br><sub>목표 응답 시간</sub> | **6주**<br><sub>2026.04 ~ 2026.05</sub> |
...
<td>PortOne V2 빌링키 + Redisson 분산락 기반 중복 결제 차단. 매일 자동 결제 스케줄</td>
</tr>
<tr>
...
| 팀원 | 주요 기여 | GitHub |
|:---:|:---|:---:|
| **곽현민**<br/>🔐 인증·인프라 | JWT/OAuth2 인증, 회원 탈퇴 2단계 처리, CI/CD | [@prAha1030](https://github.com/prAha1030) |
| **나은총**<br/>🎵 음악 콘텐츠 | Artist/Album/Track, 성능 개선, Redis 캐싱 | [@popo2381](https://github.com/popo2381) |
| **유지현**<br/>🔔 알림·소셜 | 알림 시스템, Follow/Like, Outbox, RabbitMQ | [@jihyeon1346](https://github.com/jihyeon1346) |
| **방효경**<br/>🎙️ 음악 활동 | Playback 상태 전이 설계, PlaylistTrack 성능 개선, PopularChart Snapshot | [@Banhklo2](https://github.com/Banhklo2) |
| **이준석**<br/>💳 구독·결제 | PortOne V2 결제, 포인트/지갑, 정기결제 스케줄러 | [@Perfect-Bee](https://github.com/Perfect-Bee) |
...
![KakaoPay](https://img.shields.io/badge/KakaoPay-FFCD00?style=flat&logo=kakaotalk&logoColor=black)
![Billing Key](https://img.shields.io/badge/Billing_Key-7952B3?style=flat&logo=amazonpay&logoColor=white)
![Webhook](https://img.shields.io/badge/Webhook-4B32C3?style=flat&logo=webhook&logoColor=white)
![Scheduler](https://img.shields.io/badge/Scheduler-0F9D58?style=flat&logo=googlecalendar&logoColor=white)
...
**스케줄러**: 매일 **08시 01분 충전** / **09시 01분 정기결제** (ShedLock 다중 인스턴스 락)
