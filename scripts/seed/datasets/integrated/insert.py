...
INT_COLUMNS = {"id","user_id","owner_user_id","requester_user_id","wallet_id","point_order_id","artist_id","album_id","track_id","track_number","duration_sec","play_count","track_count","total_duration_sec","balance","event_balance","total_balance","amount","balance_after","cash_amount","point_amount","subscription_amount","active","publish_delay_days","reviewed_by_admin_id"}
